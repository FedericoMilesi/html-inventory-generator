...
public class ErrorWindow2 extends javax.swing.JFrame {
    private final MainWindow mainWindow; 
    private final ItemWindow itemWindow;
    public ErrorWindow2(MainWindow mainWindow, 
    ...
    private void initComponents() {
        ...
        ErrorText.setText("You must first add item name, price and preview image.");
